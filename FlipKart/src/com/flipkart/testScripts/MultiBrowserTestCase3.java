...
public class MultiBrowserTestCase3 extends FlipKartWorkFlow {

	private static final Logger log = LogManager.getLogger(MultiBrowserTestCase3.class.getName());

	@Test
	@Parameters({"browser"})
	public void FlipKart_TC1(String browserType)
		...
		try {
			...
			FlipKart_Login_MultipleBrowser(browserType);	
